...
typedef struct {
    ngx_array_t               pools;	//Array of pools of type ngx_thread_pool_t*
...
static ngx_command_t  ngx_thread_pool_commands[] = {
	/*
	 ...
	 Defines named thread pools used for multi-threaded reading and sending of files without blocking 
	 worker processes.
